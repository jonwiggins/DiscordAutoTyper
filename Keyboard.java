...
/**
 * Adapted from https://stackoverflow.com/questions/1248510/convert-string-to-keyevents
 *
 * This class handles the simulation of user typing events
 */
public class Keyboard {
     ...
     *
     * @throws AWTException if the keyboard cannot be created
     */
    ...
    /**
     * Types the given CharSequence
     *
     * @param characters a CharSequence to type
     */
    public void type(CharSequence characters) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            //Generate a random num between 30 and 100, sleep the thread for that many millis
            int randomNum = ThreadLocalRandom.current().nextInt(30, 100);
    ...
    /**
     * Simulates the user typing the given char on the keyboard
     *
     * Taken from https://stackoverflow.com/questions/1248510/convert-string-to-keyevents
     *
     */
    ...
    private void doType(int[] keyCodes, int offset, int length) {
        ...
        try {
            ...
            System.err.println("Error: Invalid Character Entered. Keycode was: " + keyCodes);
        }
    }
